...
export class AdminController {
  ...
  @ApiOperation({
    ...
    description:
        'Create a new course as an instructor. Only authenticated instructors with admin permissions can create courses.',
  })
  @ApiBody({
  ...
  async getCourses(@CurrentUser() user: User) {
    const isAdmin = user.roles?.some(
        (role: any) =>
            role === UserRoleEnum.ADMIN || role.role === UserRoleEnum.ADMIN,
    );
  ...
  @ApiResponse({
    status: 403,
    description:
        'Forbidden - User does not have permission to update this course',
  })
  @ApiResponse({
    status: 404,
    description: 'Course not found',
  ...
  @ApiOperation({
    ...
    description:
        'Delete a course and all associated content. Only the course creator can delete it.',
  })
  @ApiParam({
    name: 'courseId',
    type: 'string',
  ...
  @ApiResponse({
    status: 403,
    description:
        'Forbidden - User does not have permission to delete this course',
  })
  @ApiResponse({
    status: 404,
    description: 'Course not found',
  ...
  @ApiOperation({
    ...
    description:
        'Publish a course to make it visible to students. Only the course creator can publish it.',
  })
  @ApiParam({
    name: 'courseId',
    type: 'string',
  ...
  @ApiResponse({
    status: 403,
    description:
        'Forbidden - User does not have permission to publish this course',
  })
  @ApiResponse({
    status: 404,
    description: 'Course not found',
  ...
  @ApiResponse({
    status: 422,
    description:
        'Unprocessable Entity - Course cannot be published (missing required content)',
  })
  @ApiBearerAuth('access-token')
  @ApiHeader({
    name: 'Authorization',
  ...
  @ApiOperation({
    ...
    description:
        'Unpublish a course to hide it from students. Only the course creator can unpublish it.',
  })
  @ApiParam({
    name: 'courseId',
    type: 'string',
  ...
  @ApiResponse({
    status: 403,
    description:
        'Forbidden - User does not have permission to unpublish this course',
  })
  @ApiResponse({
    status: 404,
    description: 'Course not found',
  ...
  @ApiOperation({
    ...
    description:
        'Upload a thumbnail image for a course. Supported formats: JPEG, PNG. Max size: 5MB',
  })
  @ApiParam({
    name: 'courseId',
    type: 'string',
  ...
  @ApiResponse({
    status: 403,
    description:
        'Forbidden - User does not have permission to upload thumbnail for this course',
  })
  @ApiResponse({
    status: 404,
    description: 'Course not found',
  ...
  async uploadCourseThumbnail(
    ...
    return this.mediaUploadService.uploadCourseThumbnail(courseId, file, user);
  }
  ...
  @ApiOperation({
    ...
    description:
        'Create a new unit within a course. Only the course creator can add units.',
  })
  @ApiParam({
    name: 'courseId',
    type: 'string',
  ...
  @ApiResponse({
    status: 403,
    description:
        'Forbidden - User does not have permission to add units to this course',
  })
  @ApiResponse({
    status: 404,
    description: 'Course not found',
  ...
  @ApiOperation({
    summary: 'Update unit',
    description:
        'Update an existing unit. Only the course creator can update units.',
  })
  @ApiParam({
    name: 'unitId',
    type: 'string',
  ...
  @ApiResponse({
    status: 403,
    description:
        'Forbidden - User does not have permission to update this unit',
  })
  @ApiResponse({
    status: 404,
    description: 'Unit not found',
  ...
  @ApiOperation({
    summary: 'Delete unit',
    description:
        'Delete a unit and all associated content. Only the course creator can delete units.',
  })
  @ApiParam({
    name: 'unitId',
    type: 'string',
  ...
  @ApiResponse({
    status: 403,
    description:
        'Forbidden - User does not have permission to delete this unit',
  })
  @ApiResponse({
    status: 404,
    description: 'Unit not found',
  ...
  @ApiOperation({
    ...
    description:
        'Add a prerequisite unit that must be completed before this unit. Only the course creator can add prerequisites.',
  })
  @ApiParam({
    name: 'unitId',
    type: 'string',
  ...
  @ApiResponse({
    status: 403,
    description:
        'Forbidden - User does not have permission to add prerequisites to this unit',
  })
  @ApiResponse({
    status: 404,
  ...
  @ApiOperation({
    ...
    description:
        'Remove a prerequisite requirement from a unit. Only the course creator can remove prerequisites.',
  })
  @ApiParam({
    name: 'unitId',
    type: 'string',
  ...
  @ApiResponse({
    status: 403,
    description:
        'Forbidden - User does not have permission to remove prerequisites from this unit',
  })
  @ApiResponse({
    status: 404,
  ...
  @ApiOperation({
    ...
    description:
        'Create a new exercise within a unit. Requires admin privileges.',
  })
  @ApiParam({
    name: 'unitId',
    type: 'string',
  ...
  @ApiBody({
    ...
    description:
        'Exercise data (title, prompt, difficulty, language, starter code, CPU/memory limits)',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    ...
    description:
        'Retrieve full details of a specific exercise including test cases and hints.',
  })
  @ApiParam({
    name: 'exerciseId',
    type: 'string',
  ...
  @ApiOperation({
    ...
    description:
        'Permanently delete an exercise. Also deletes all associated test cases and hints.',
  })
  @ApiParam({
    name: 'exerciseId',
    type: 'string',
  ...
  @ApiOperation({
    ...
    description:
        'Add a new test case to an exercise. Test cases are used to validate student solutions.',
  })
  @ApiParam({
    name: 'exerciseId',
    type: 'string',
  ...
  @ApiBody({
    ...
    description:
        'Test case data (input text, expected output, optional description)',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiBody({
    ...
    description:
        'Partial test case data (input, expected output, or description)',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    summary: 'Add hint',
    description:
        'Add a new hint to an exercise. Hints are unlocked after failed attempts.',
  })
  @ApiParam({
    name: 'exerciseId',
    type: 'string',
  ...
  @ApiBody({
    type: CreateHintDto,
    description:
        'Hint data (content 10-1000 chars, required failed attempts to unlock)',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiBody({
    type: CreateQuizDto,
    description:
        'Quiz data (title, instructions, passing score, time limit, randomize options)',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiOperation({
    ...
    description:
        'Retrieve full details of a specific quiz including all questions and options.',
  })
  @ApiParam({
    name: 'quizId',
    type: 'string',
  ...
  @ApiBody({
    type: UpdateQuizDto,
    description:
        'Partial quiz data (title, instructions, passing score, time limit, etc)',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    summary: 'Delete quiz',
    description:
        'Permanently delete a quiz. Also deletes all associated questions and options.',
  })
  @ApiParam({
    name: 'quizId',
    type: 'string',
  ...
  @ApiOperation({
    ...
    description:
        'Add a new question to a quiz. Question must include prompt and at least one option.',
  })
  @ApiParam({
    name: 'quizId',
    type: 'string',
  ...
  @ApiBody({
    ...
    description:
        'Question data (prompt 5-2000 chars, points 1-100, explanation, options array)',
  })
  @ApiResponse({
    status: 201,
  ...
  @ApiResponse({
    status: 422,
    description:
        'Unprocessable entity - Invalid question data (e.g., no options)',
  })
  @Roles(UserRoleEnum.INSTRUCTOR, UserRoleEnum.ADMIN)
  ...
  @ApiOperation({
    ...
    description:
        'Permanently delete a question from a quiz. Also deletes all associated options.',
  })
  @ApiParam({
    name: 'questionId',
    type: 'string',
  ...
  @ApiOperation({
    ...
    description:
        'Update option details within a quiz question. All fields are optional.',
  })
  @ApiParam({
    name: 'optionId',
    type: 'string',
  ...
  @ApiBody({
    ...
    description:
        'Partial option data (label 1-500 chars, isCorrect boolean, position)',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
        'Create a new module content resource for a unit. Instructors can add learning material to units.',
  })
  @ApiParam({
    name: 'unitId',
    type: 'string',
  ...
  @ApiOperation({
    ...
    description:
        'Upload a video file for module content. Supported formats: MP4, WebM. Max size: 500MB.',
  })
  @ApiParam({
    name: 'unitId',
    type: 'string',
  ...
  @ApiOperation({
    ...
    description:
        'Upload a resource file (PDF, DOC, etc.) for a unit. Supported formats: PDF, DOCX, XLSX, PPTX. Max size: 100MB.',
  })
  @ApiParam({
    name: 'unitId',
    type: 'string',
    ...
    schema: {
      ...
      properties: {
        file: {
          ...
          format: 'binary',
          description:
              'Resource file (PDF, DOCX, XLSX, PPTX format, max 100MB)',
        },
        label: {
          type: 'string',
  ...
  @ApiOperation({
    ...
    description:
        'Create a new question for a final exam. Questions support multiple choice format.',
  })
  @ApiParam({
    name: 'unitId',
    type: 'string',
  ...
  @ApiOperation({
    ...
    description:
        'Permanently delete a final exam question. Also deletes all associated options.',
  })
  @ApiParam({
    name: 'unitId',
    type: 'string',
  ...
  @ApiOperation({
    ...
    description:
        'Permanently delete an answer option from a final exam question',
  })
  @ApiParam({
    name: 'unitId',
    type: 'string',
  ...
  @ApiOperation({
    ...
    description:
        'Retrieve all available badges in the system. Requires admin authentication.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description: 'Create a new badge using structured criteria fields only.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Update a badge and its structured criteria fields.',
  })
  ...
  @ApiOperation({
    ...
    description:
        'Upload an icon image for a badge. Supported formats: JPEG, PNG. Optional - if not provided, badge will display emoji.',
  })
  @ApiParam({
    name: 'badgeId',
    type: 'string',
